...
{{-- CONTENT CONTACT --}}
  <body class="u-body u-xl-mode" data-lang="en">
    <section class="u-align-center u-black u-clearfix u-section-1" id="carousel_b3bb">
      {{-- ubah background --}}
      <img class="u-expanded-width u-image u-image-1" src="img/BGcarousel1.jpg" data-image-width="6067" data-image-height="3467">
      {{-- List --}}
          ...
          <div class="u-align-center u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-white u-list-item-1">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1">
              <span class="u-file-icon u-icon u-text-palette-3-base u-icon-1">
                <img src="img/lokasi.png" alt="lokasi udinus">
              </span>
              <h5 class="u-text u-text-1">our Main Campus</h5>
              <p class="u-text u-text-2">Jl. Imam Bonjol No. 207 Semarang
          ...
          <div class="u-align-center u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-white u-list-item-2">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2">
              <span class="u-file-icon u-icon u-text-palette-3-base u-icon-2">
                <img src="img/phone.png" alt="phone udinus">
              </span>
              <h5 class="u-text u-text-3">phone number</h5>
              <p class="u-text u-text-4">(024) 3517261<br>(+6224) 3520165 (Toll Free)
              </p>
            </div>
          </div>
          {{-- item fax --}}
          <div class="u-align-center u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-white u-list-item-3">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3">
              <span class="u-file-icon u-icon u-text-palette-3-base u-icon-3">
                <img src="img/fax.png" alt="fax udinus">
              </span>
              <h5 class="u-text u-text-5">Fax</h5>
              <p class="u-text u-text-6">(024) 3569684</p>
            </div>
          </div>
          {{-- item gmail --}}
          <div class="u-align-center u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-white u-list-item-4">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-4">
              <span class="u-file-icon u-icon u-text-palette-3-base u-icon-4">
                <img src="img/gmail.png" alt="gmail udinus">
              </span>
              <h5 class="u-text u-text-7">Email</h5>
              <p class="u-text u-text-8">
                <a href="mailto:psi.udinus@gmail.com" class="u-active-none u-border-1 u-border-active-black u-border-hover-black u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-hover-none u-none u-text-active-palette-3-base u-text-hover-palette-3-base u-text-palette-3-base u-btn-1">
                  psi.udinus@gmail.com</a>
              </p>
            </div>
          </div>
          ...
          <div class="u-layout-row">
            ...
            <div class="u-align-left u-container-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
              <div class="u-container-layout u-container-layout-6">
                <h2 class="u-align-left u-text u-text-body-alt-color u-text-default u-text-9">Hospitality</h2>
                <h6 class="u-align-left u-custom-font u-text u-text-body-alt-color u-text-font u-text-10"> 
                  Hospitality is the relationship between the customer and the provider, in this case the student and the University.
                </h6>
                <p class="u-align-left u-text u-text-body-alt-color u-text-11">
                  aims to provide students who have complaints against the services of the University of Dian Nuswantoro either technically or not, so as to find a solution for the convenience of students.
                </p>
                
                {{-- SOSMED --}}
                <div class="u-social-icons u-spacing-20 u-social-icons-1">
                   {{-- SOSMED 1 facebook --}}
                  <a class="u-social-url" target="_blank" href="https://www.facebook.com/udinus.smg">
                  ...
                  {{-- SOSMED 2 twitter --}}
                  <a class="u-social-url" target="_blank" href="https://twitter.com/udinus_smg">
                  ...
                  {{-- SOSMED 3 instagram --}}
                  <a class="u-social-url" target="_blank" href="https://www.instagram.com/udinusofficial/">
                   ...
                   {{-- SOSMED 4 linkedin--}}
                  <a class="u-social-url" target="_blank" href="https://www.linkedin.com/school/universitas-dian-nuswantoro/">
